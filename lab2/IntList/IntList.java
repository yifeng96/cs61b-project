...
public class IntList {
   ...
   **  elements of B.  May modify items of A. Don't use 'new'. */
    /*  public static Intlist dcatenateHelper(Intlist A, Intlist B, Intlist C) {
      if (A == null) {
	  return B;
      }
      if (B == null) {
	  ...
	  IntList temp = A.tail; //<2,3>
	  A.tail = B; //<A:(1,4,5,6)>
	  IntList pointer = A.tail.tail;//<5,6>
	  return null;
      }
   } */
  ...
  public static IntList catenate(IntList A, IntList B) {
    ...
    if (B == null) {
     return A;
      ...
      IntList C = new IntList(A.head, catenate(A.tail, B));
      return C;
    }
  }
